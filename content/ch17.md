...
] our application to do something**, the database engine is
**[ told ] by our application to do something** . This is a very relevant
...
These _Adapters_, however, are not randomly created. They are created
...
according to sub-domains and
[**_bounded_ _contexts_**](http://ddd.fed.wiki.org/view/welcome-visitors/view/domain-driven-design/view/bounded-context),
following Robert C. Martin ideas expressed in
**_[screaming architecture](https://8thlight.com/blog/uncle-bob/2011/09/30/Screaming-Architecture.html)_**.
...
picking up on Simon Brown diagram about _Package by component_, I would
...
that will be shared among all components, the
