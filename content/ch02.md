...
No matter how you understand what I talk about in _[The Software Architecture Chronicles](ch01.md)_, above all please understand that **there are no silver bullets**,
...
- It **prepares the project for reuse** of components and modules
  ^[\[7\]:pp.29--35](#7)^ ;
- It establishes **standards for consistency of results and lightweight of processes**, like
